...
public class Goli extends Creep{
	...
	private void initPics(){// initiallize the pictures of the creep
		ImageIcon img1 = new ImageIcon(this.getClass().getResource("/icons/guli-1.png"));
		Image scale1 = img1.getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH);
		ImageIcon img2 = new ImageIcon(this.getClass().getResource("/icons/guli-2.png"));
		Image scale2 = img2.getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH);
		ImageIcon img3 = new ImageIcon(this.getClass().getResource("/icons/guli-3.png"));
		Image scale3 = img3.getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH);
		ImageIcon img4 = new ImageIcon(this.getClass().getResource("/icons/guli-4.png"));
		Image scale4 = img4.getImage().getScaledInstance(25, 25, Image.SCALE_SMOOTH);
		ImageIcon img5 = new ImageIcon(this.getClass().getResource("/icons/guli-5.png"));
